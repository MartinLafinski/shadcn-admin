  ...
  try {
    ...
    return (
      <div className="flex items-center gap-1 flex-wrap">
        ...
        <Badge variant="outline" className="text-sm px-1.5 font-mono font-normal">
          <span className="text-foreground dark:text-zinc-100 text-xs">{dateStr}</span>
          <span className="text-green-700 dark:text-green-500  text-xs">{timeStr}</span>
        </Badge>
