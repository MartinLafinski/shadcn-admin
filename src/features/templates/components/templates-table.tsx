 ...
 */
export function TemplatesTable({ data = [], pager = undefined, isLoading = false, isFetching = false }: DataTableProps) {
  // 表格状态管理
  // 从 context 获取搜索参数
  ...
  const table = useReactTable({
    ...
    onPaginationChange: (updater) => {
      ...
      // setSearchParams({
      //   template_keyword: searchParams.template_keyword || undefined,
      //   template_enabled: searchParams.template_enabled,
      //   page: newPagination.pageIndex + 1,
      //   size: newPagination.pageSize,
      // })
    }, // 分页状态变更时的回调
