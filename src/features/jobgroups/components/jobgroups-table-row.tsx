...
interface JobGroupsTableRowProps {
  row: Row<JobGroupItemData>
  rowIdx: number
  isSelected: boolean
  getPinningStyles: (column: Column<JobGroupItemData>) => PinningStyles
}

function JobGroupsTableRowBase({
  row,
  rowIdx,
  isSelected,
  getPinningStyles,
}: JobGroupsTableRowProps) {
  return (
    <TableRow
      key={row.id}
...
export const JobGroupsTableRow = JobGroupsTableRowBase
