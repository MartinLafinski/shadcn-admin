...
import { Server, Hash, Network, Tag, Monitor, Globe, Info } from 'lucide-react'
...
interface ServersDetailDialogProps {
  open: boolean
  onOpenChange: (open: boolean) => void
  server: ClusterServerData
}

export function ServersDetailDialog({
  open,
  onOpenChange,
  server,
}: ServersDetailDialogProps) {
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className='max-w-lg'>
        <DialogHeader>
          ...
          <DialogDescription>服务器详细信息</DialogDescription>
        </DialogHeader>
          ...
          <div className='grid grid-cols-2 gap-3'>
            <div className='flex items-center gap-2 rounded-lg border bg-muted/30 p-3'>
              ...
              <div className='min-w-0'>
                ...
                <p className='truncate text-sm font-medium'>{server.node_id}</p>
              </div>
            </div>
            <div className='flex items-center gap-2 rounded-lg border bg-muted/30 p-3'>
            ...
            <div className='flex items-center gap-2 rounded-lg border bg-muted/30 p-3'>
              ...
              <div className='min-w-0'>
                ...
                <p className='truncate text-sm font-medium'>{server.id}</p>
              </div>
            </div>
          </div>
