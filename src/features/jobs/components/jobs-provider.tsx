 ...
 */
type JobsDialogType = 'create' | 'delete' | 'export' | 'view' | 'viewWebsite' | 'viewEntrypoint'
...
export function JobsProvider({
    ...
    }, [search.day, search.website_id, search.entrypoint_id, search.status, search.page, search.size])

    return (
        <JobsContext value={{ open, setOpen, currentRow, setCurrentRow, searchParams, setSearchParams }}>
            {children}
        </JobsContext>
    )
}
