...
export function EntrypointsViewDialog({ open, onOpenChange, entrypoint }: EntrypointsViewDialogProps) {
                    ...
                    >
                      <div className="flex items-center gap-2">
                        ...
                        <div className="flex flex-col">
                          <span className="font-medium">{entrypoint.website.website_name}</span>
