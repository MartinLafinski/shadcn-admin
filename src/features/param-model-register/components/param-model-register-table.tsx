...
import { paramModelRegisterColumns } from './param-model-register-columns'
import {
  useParamModelRegistersSearch,
  useParamModelRegistersActions,
} from './param-model-register-provider'
import { ParamModelRegisterTableRow } from './param-model-register-table-row'
...
interface DataTableProps {
  data: ParamModelRegisterData[] | undefined
  pager?: PaginationInfoData
  isLoading?: boolean
  isFetching?: boolean
}

const ParamModelRegisterTableComponent = ({
  data = [],
  pager = undefined,
  isLoading = false,
  isFetching = false,
  ...
  function pinningStyles(column: Column<ParamModelRegisterData>) {
    return getPinningStyles(column, pinnedLeftIds, pinnedRightIds)
  }

  const table = useReactTable({
    data,
    columns: paramModelRegisterColumns,
    ...
    globalFilterFn: (row, _, filterValue) => {
      const searchKeys = ['register_name', 'register_slug', 'spider_slug']
  ...
  return (
    ...
    >
      ...
      <DataTableToolbar
        table={table}
        searchPlaceholder='过滤 名称/标识/爬虫标识...'
        filters={[
          {
        ...
        storageKey='param-model-register-column-vis'
      />
          ...
          <Table>
            ...
            <TableBody>
              {isLoading ? (
                <TableRow>
                  <TableCell
                    colSpan={paramModelRegisterColumns.length}
...
export const ParamModelRegisterTable = ParamModelRegisterTableComponent
