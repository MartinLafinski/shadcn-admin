 ...
 */
type PreTasksDialogType = 'reset' | 'clear' | 'view' | 'viewWebsite' | 'viewEntrypoint'
...
export function PreTasksProvider({
    ...
    // 管理搜索参数状态
    const [searchParams, setSearchParams] = useState<PreTaskSearchParams>(initialSearchParams)
    ...
    return (
        <PreTasksContext value={{ open, setOpen, currentRow, setCurrentRow, searchParams, setSearchParams }}>
            {children}
        </PreTasksContext>
    )
}
