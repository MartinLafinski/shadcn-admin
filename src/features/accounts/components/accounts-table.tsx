...
export function AccountsTable({
  ...
  const pinnedLeftIds = ['select', 'user_id', 'username']
  ...
  function getPinningStyles(column: Column<AccountData>) {
  ...
  const table = useReactTable({
    ...
    globalFilterFn: (row, _, filterValue) => {
      const searchKeys = ['username', 'email']
