...
interface ParamModelRegisterTableRowProps {
  row: Row<ParamModelRegisterData>
  rowIdx: number
  isSelected: boolean
  getPinningStyles: (column: Column<ParamModelRegisterData>) => PinningStyles
}

function ParamModelRegisterTableRowBase({
  row,
  rowIdx,
  isSelected,
  getPinningStyles,
}: ParamModelRegisterTableRowProps) {
  return (
    <TableRow
      key={row.id}
...
export const ParamModelRegisterTableRow = ParamModelRegisterTableRowBase
