...
export function ReqsViewDialog({ open, onOpenChange, req }: ReqsViewDialogProps) {
            ...
            <div className='space-y-6 px-6 pb-6'>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                ...
                <div className='space-y-1'>
                  ...
                  <div className='rounded-md border p-2 bg-background text-sm flex items-center gap-2'>
                ...
                <div className='space-y-1'>
                  ...
                  {req.url ? (
                    <a
                      ...
                      className='rounded-md border p-2 bg-background text-sm break-all text-blue-600 hover:text-blue-800 hover:underline block'
                    >
                      {req.url}
                    </a>
                  ) : (
                    <div className='rounded-md border p-2 bg-background text-sm text-gray-400'>
                      -
                    </div>
                  )}
                </div>
              ...
              {(req.exp_type || req.exp_msg) && (
                <div className="space-y-4">
                  ...
                  <div className='grid grid-cols-1 md:grid-cols-2 gap-3'>
                    ...
                    {req.exp_type && (
                      <div className='space-y-1'>
                        <span className='text-xs text-muted-foreground'>异常类型</span>
                        <div className='rounded-md border p-2 bg-background text-sm break-all'>
                          {req.exp_type}
                        </div>
                      </div>
                    ...
                    {req.exp_msg && (
                      <div className='space-y-1'>
                        <span className='text-xs text-muted-foreground'>异常消息</span>
                        <div className='rounded-md border p-2 bg-background text-sm break-all'>
                          {req.exp_msg}
                        </div>
                      </div>
              ...
              {(req.discard_type || req.discard_msg) && (
                <div className="space-y-4">
                  ...
                  <div className='grid grid-cols-1 md:grid-cols-2 gap-3'>
                    ...
                    {req.discard_type && (
                      <div className='space-y-1'>
                        <span className='text-xs text-muted-foreground'>丢弃类型</span>
                        <div className='rounded-md border p-2 bg-background text-sm break-all'>
                          {req.discard_type}
                        </div>
                      </div>
                    ...
                    {req.discard_msg && (
                      <div className='space-y-1'>
                        <span className='text-xs text-muted-foreground'>丢弃消息</span>
                        <div className='rounded-md border p-2 bg-background text-sm break-all'>
                          {req.discard_msg}
                        </div>
                      </div>
