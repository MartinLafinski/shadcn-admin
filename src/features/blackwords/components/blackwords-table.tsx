...
export function BlackwordsTable({
  data = [],
  pager = undefined,
  isLoading = false,
  isFetching = false,
}: BlackwordsTableProps) {
  // 表格状态管理
  // 从 context 获取搜索参数
  ...
  const pinnedRightIds = ['blackwords_enabled', 'actions']
  ...
  function getPinningStyles(column: Column<BlackwordData>) {
