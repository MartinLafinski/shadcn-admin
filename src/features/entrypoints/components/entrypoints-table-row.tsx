...
interface EntrypointTableRowProps {
  row: Row<EntrypointItemData>
  rowIdx: number
  isSelected: boolean
  getPinningStyles: (column: Column<EntrypointItemData>) => PinningStyles
}

const EntrypointTableRowBase = ({
  row,
  rowIdx,
  isSelected,
  getPinningStyles,
}: EntrypointTableRowProps) => {
  return (
    <TableRow
      key={row.id}
...
export const EntrypointTableRow = EntrypointTableRowBase
