...
interface ParamFormsTableRowProps {
  row: Row<ParamFormItemData>
  rowIdx: number
  isSelected: boolean
  getPinningStyles: (column: Column<ParamFormItemData>) => PinningStyles
}

function ParamFormsTableRowBase({
  row,
  rowIdx,
  isSelected,
  getPinningStyles,
}: ParamFormsTableRowProps) {
  return (
    <TableRow
      key={row.id}
...
export const ParamFormsTableRow = ParamFormsTableRowBase
